...
export const X_ARBOUR = "x-arbour";
...
export class ComposeDocument {
    ...
    get xArbour(): ComposeArbour {
        return new ComposeArbour(this.composeData);
    }
...
export class ComposeArbour extends ComposeMap {

    constructor(protected baseComposeData: ComposeData) {
        super(X_ARBOUR, baseComposeData);
    }
