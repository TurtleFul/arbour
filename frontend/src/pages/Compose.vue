<template>
    <transition name="slide-fade" appear>
        <div>
            ...
            <div v-if="stack.isManagedByArbour" class="row mt-3">
                <div class="col-xl-6">
                    <!-- General -->
                    <div v-if="isAdd">
                    ...
                    <div v-if="isEditMode">
                        ...
                        <div class="shadow-box big-padding mb-3">
                            ...
                            <div class="mb-4">
                                ...
                                <ArrayInput :composeArray="composeDocument.xArbour.urls" :display-name="$t('url')" placeholder="https://" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="shadow-box mb-3 editor-box" :class="{'edit-mode' : isEditMode}">
                        ...
                        <CodeEditor
                            ...
                            lang="yaml"
                            :readonly="!isEditMode"
                            @update:model-value="yamlCodeChange"
...
export default defineComponent({
    ...
    computed: {
        ...
        urls(this: {composeDocument: ComposeDocument}): {display: string, url: string}[] {
            ...
            for (const url of this.composeDocument.xArbour.urls.values) {
                let display;
                try {
                    let obj = new URL(url);
